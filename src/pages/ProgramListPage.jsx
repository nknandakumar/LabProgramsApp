...
const ProgramListPage = () => {
	...
	return (
		<div className="px-4 sm:px-8 md:px-16 lg:px-[112px] min-h-screen flex flex-col gap-4 sm:gap-6 md:gap-10 items-start justify-start py-4 sm:py-6 md:py-8">
			<div className=" bg-[#000000] space-y-4 fixed z-20 w-full top-0  ">
				<Link className=" " to={`/subjects`}>
				...
				<div className="flex mt-6  flex-col sm:flex-row sm:items-baseline gap-4 sm:gap-6 md:gap-8 justify-between w-full">
					<div className="flex flex-col justify-start gap-2 sm:gap-4 md:gap-6 items-start">
						...
						<p className="text-sm pb-4 sm:text-base md:text-lg">
							{subjectDescription}
						</p>
					</div>
				</div>
			</div>
			<div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-3 sm:gap-4 md:gap-6 mt-50 md:mt-60 w-full">
