...
const App = () => {
 ...
 <button className="font-sans bg-black text-white uppercase px-4 py-0.5 font-[600]  tracking-wide leading-[50px] text-[16px] cursor-pointer rounded-lg">Click here for Lab Programs 
